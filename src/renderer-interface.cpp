...
void renderer_gridScroll(RendererHandle r, int gridId, int startRow, int endRow,
                         int startCol, int endCol, int rows, int cols) {
  static_cast<Renderer *>(r)->gridScroll(gridId, startRow, endRow, startCol,
                                         endCol, rows, cols);
}
...
void renderer_bell(RendererHandle r) { static_cast<Renderer *>(r)->bell(); }

void renderer_visualBell(RendererHandle r) {
  static_cast<Renderer *>(r)->visualBell();
}

void renderer_defaultColorsSet(RendererHandle r, int rgbFg, int rgbBg,
                               int rgbSp, int ctermFg, int ctermBg) {
  static_cast<Renderer *>(r)->defaultColorsSet(rgbFg, rgbBg, rgbSp, ctermFg,
                                               ctermBg);
}

void renderer_flush(RendererHandle r) { static_cast<Renderer *>(r)->flush(); }
...
void renderer_rawLine(RendererHandle r, int gridId, int lineRow, int startCol,
                      int endCol, int clearCol, int clearAttr, int flags,
                      const char *chunk, const int *attrs) {
  static_cast<Renderer *>(r)->rawLine(gridId, lineRow, startCol, endCol,
